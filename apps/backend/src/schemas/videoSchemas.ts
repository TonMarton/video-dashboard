...
export const getVideosQuerySchema = Joi.object({
  ...
  sortBy: Joi.string().valid(...Object.values(VideoSortField)).default(VideoSortField.CREATED_AT),
  sortOrder: Joi.string().valid(...Object.values(SortOrder)).default(SortOrder.DESC),
